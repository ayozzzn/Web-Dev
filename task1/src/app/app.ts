...
@Component({
  ...
  template: `
    ...
    <app-user [name]="'John'"></app-user>
    <app-user [name]="'Charlie'"></app-user>
    <app-user [name]="'Jessie'"></app-user>
  ...
  `,
  imports: [User, Child, Comments, RouterLink, RouterOutlet, ReactiveFormsModule, FormsModule, LowerCasePipe, CurrencyPipe, DecimalPipe, DatePipe, ReversePipe],
})
